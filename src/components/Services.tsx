  ...
  const services = [
    {
      ...
      description: "Instalação completa de sistemas fotovoltaicos residenciais, comerciais e industriais, com equipe especializada e materiais de alta qualidade.",
    },
    {
      icon: <Wrench size={40} className="text-primary mb-4" />,
      title: "Manutenção Preventiva e Corretiva",
      description: "Serviços de manutenção para garantir o máximo desempenho do seu sistema solar, aumentando sua vida útil e eficiência energética.",
    },
    {
      icon: <Hammer size={40} className="text-primary mb-4" />,
      title: "Reparos e Consertos",
      description: "Diagnóstico e resolução rápida de problemas em sistemas solares, com técnicos qualificados e peças originais.",
    },
    {
      icon: <PenTool size={40} className="text-primary mb-4" />,
      title: "Projetos Personalizados",
      description: "Desenvolvimento de projetos fotovoltaicos sob medida, considerando necessidades específicas, espaço disponível e consumo energético.",
    }
  ];
